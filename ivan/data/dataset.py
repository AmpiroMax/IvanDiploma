...
class ElectroInterDataset(Dataset):
    def __init__(self, data_foulder_path: str) -> None:
        ...
        for i, file_name in enumerate(os.listdir(data_foulder_path + "/images")):
            ...
            scale = self._open_scale(data_foulder_path + "/scales/" + scale_file_name)
    ...
    def __getitem__(self, idx):
        image_tensor = self.transform(self.data[idx][0]).permute(2, 0, 1)[None, ...]
        label_tensor = self.transform(self.data[idx][1]).permute(2, 0, 1)[None, ...]
